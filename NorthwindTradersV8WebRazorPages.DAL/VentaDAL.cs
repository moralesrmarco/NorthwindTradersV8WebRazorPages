...
namespace NorthwindTradersV8WebRazorPages.DAL
{
    public class VentaDAL
    {
        ...
        public List<Venta> ObtenerVentas(bool selectorRealizaBusqueda, VentasBuscarDto criterios, bool top100 = false)
        {
            ...
            try
            {
                ...
                using (var cmd = new SqlCommand())
                {
                    ...
                    if (selectorRealizaBusqueda)
                    {
                        ...
                        // Numéricos
                        cmd.Parameters.Add("@IdIni", SqlDbType.Int).Value = criterios.IdIni ?? 0;
                        cmd.Parameters.Add("@IdFin", SqlDbType.Int).Value = criterios.IdFin ?? 0;

                        // Strings
                        cmd.Parameters.Add("@Cliente", SqlDbType.NVarChar, 40).Value = criterios.Cliente ?? string.Empty;
                        cmd.Parameters.Add("@Empleado", SqlDbType.NVarChar, 31).Value = criterios.Empleado ?? string.Empty;
                        cmd.Parameters.Add("@CompañiaT", SqlDbType.NVarChar, 40).Value = criterios.CompañiaT ?? string.Empty;
                        cmd.Parameters.Add("@Dirigidoa", SqlDbType.NVarChar, 40).Value = criterios.DirigidoA ?? string.Empty;
                        // Bits
