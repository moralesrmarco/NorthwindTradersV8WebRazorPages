...
namespace NorthwindTradersV8WebRazorPages.Pages.Categorias.Reportes
{
    public class CategoriasConProductosRptModel : PageModel
    {
        ...
        public CategoriasConProductosRptModel(IConfiguration configuration)
        {
        ...
        private LocalReport CrearReporte()
        {
            ...
            var categoriasConProductos = categoriaBLL.ObtenerCategoriasConProductosRpt();

            reporte.DataSources.Clear();
            reporte.DataSources.Add(
                new ReportDataSource("DataSet1", categoriasConProductos));
