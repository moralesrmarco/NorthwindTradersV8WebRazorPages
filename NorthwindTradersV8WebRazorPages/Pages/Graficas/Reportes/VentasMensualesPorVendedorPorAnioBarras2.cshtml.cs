...
{
    public class VentasMensualesPorVendedorPorAnioBarras2Model : PageModel
    {
        ...
        public VentasMensualesPorVendedorPorAnioBarras2Model(
        ...
        public IActionResult OnGetVerPdf()
        {
            try
            {
                ...
                string rdlcPath = Path.Combine(
                    ...
                    "Graficas",
                    "Reportes",
                    "RptGraficaVentasMensualesPorVendedorPorAnioBarras2.rdlc");
